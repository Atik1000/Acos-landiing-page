                ...
                <div className="row align-items-center">
                    ...
                    <div className="col">
                        ...
                        <p style={{ fontWeight: 400 }}>
                            ...
                            campaigns. With its user-friendly interface and advanced algorithms,
                            ACoS.app empowers Amazon sellers to <b>reduce wasted ad spend </b> and{' '}
                            <b>lower ACoS</b> (Advertising Cost of Sale).
                        </p>
                    </div>
                </div>
                <div className="row mt-4 pt-4">
                    <div className="col-5">
                        ...
                        <p className="pb-4 mb-4" style={{ fontWeight: 400 }}>
                            ...
                            keywords and targets and make the appropriate bid adjustments. ACoS.app
                            offers the easiest and most streamlined solution for making bid
                            adjustments in bulk, <b>saving you valuable time and effort</b> and
